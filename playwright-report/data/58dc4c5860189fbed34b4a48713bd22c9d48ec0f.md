...
- Name: auth.spec.js >> Authentication flow >> navigates to login when Start Planning is clicked
- Location: e2e\auth.spec.js:25:3
...
Locator: getByPlaceholder('john@email.com')
Expected: visible
Timeout: 5000ms
