...
- Name: auth.spec.js >> Authentication flow >> shows validation errors on empty login submit
- Location: e2e\auth.spec.js:31:3
...
- generic [ref=e3]:
  ...
  - generic [ref=e12]:
    ...
    - generic [ref=e16]:
      ...
      - generic [ref=e19]: Username is required.
    - generic [ref=e20]:
      - generic [ref=e21]: Password
      - textbox "••••••••" [ref=e22]
      - generic [ref=e23]: Password is required.
    - button "Log In" [active] [ref=e24] [cursor=pointer]
    - generic [ref=e25]:
      - text: "Admin:"
      - code [ref=e26]: admin
      - text: /
      - code [ref=e27]: admin123
      - text: "User:"
      - code [ref=e28]: alice
      - text: /
      - code [ref=e29]: user123
    - generic [ref=e30]:
